...
export const getProductsByShop = (shopId, page = 0, pageSize = 20) =>
  axiosClient.get(
    `/api/products/shop/${shopId}?page=${page}&pageSize=${pageSize}`,
  );

export const getProductsByCategory = (categoryId, page = 0, pageSize = 20) =>
  axiosClient.get(
    `/api/products/category/${categoryId}?page=${page}&pageSize=${pageSize}`,
  );
